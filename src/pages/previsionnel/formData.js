export const formInitialValues = {
    ...
    prenom: "",
    nom_projet: "",
    form_juridique: "SARL (IS)",
    num_telephone: "",
    email: "",
    commune: "",
    code_postal: "",
    activite: "Marchandises (y compris hébergement et restauration)",
    duree_amortissement: "",
    besoin_demarage: {
        frais_etablissement: "",
        frais_compteurs: "",
    ...
    financement_demarage: {
        ...
        subvention_1: { label: "", montant: "" },
        subvention_2: { label: "", montant: "" },
...
export const besoinDemarageDataArray = [
    {
...
export const chargesFixesDataArray = [
    {
        name: "assurances",
        label: "Assurances",
        comment: "Ce sont les frais de création de l’entreprise (formalités)",
